...
const EditUsersDataContainer = ({open, handleClose, user, updateUsers, isUpdated}) => {
    return (
        <EditUsersData user={user} open={open} handleClose={handleClose} updateUsers={updateUsers} isUpdated={isUpdated} />
    );
}
